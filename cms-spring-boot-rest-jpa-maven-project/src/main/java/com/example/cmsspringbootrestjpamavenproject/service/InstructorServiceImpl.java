...
public class InstructorServiceImpl implements InstructorService{
	...
	public List<InstructorPojo> fetchAllInstructors() {
		...
		for(InstructorEntity eachInstructorEntity: allInstructorsEntity) {
			...
			List<CoursePojo> allBooksPojo = new ArrayList<>();
			for(CourseEntity eachBookEntity: eachInstructorEntity.getAllcourses()) {
				CoursePojo bookPojo = new CoursePojo();
				BeanUtils.copyProperties(eachBookEntity, bookPojo);
				allInstructorsPojo.add(instructorPojo);
			}
			instructorPojo.setAllCourses(allBooksPojo);
			allInstructorsPojo.add(instructorPojo);
		}
